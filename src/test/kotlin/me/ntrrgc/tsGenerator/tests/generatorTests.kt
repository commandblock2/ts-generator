...
"""))
    ...
    "handles ClassRange with Custom Name Generate" {
    ...
    "handles ClassWithCustomClassNameProperties using mappingKtToTs" {
    ...
    "handles DataStorage using mapping" {
